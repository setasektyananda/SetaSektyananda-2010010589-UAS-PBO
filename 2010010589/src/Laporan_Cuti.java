 ...
 * @author Sidiq
 */
public class Laporan_Cuti extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tablecuti.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nama", "No. Peg", "Alasan", "Mulai", "Berakhir", "Perihal"
            }
        ) {
    ...
    private void loadTabel() {
        ...
        tablecuti.setModel(new ResultSetTable(rs));
    }


    public void cetak() {
        try {
            tablecuti.print(JTable.PrintMode.FIT_WIDTH, new MessageFormat("Data Pegawai yang cuti"), null);
